				...
				if (usuarioLogado.isEmpresa()) {
					...
					switch (escolha) {
						case 1: {
							...
							System.out.println("VENDAS EFETUADAS");
							vendas.stream().forEach(venda -> {
								// Verificar se a empresa está definida antes de acessá-la
								if (venda.getEmpresa() != null && venda.getEmpresa().getId().equals(usuarioLogado.getEmpresa().getId())) {
									System.out.println("************************************************************");
									...
									if (venda.getEmpresa() != null) {
										...
										System.out.println("Empresa não definida.");
									}
									System.out.println("************************************************************");
								}
							});
							...
							if (usuarioLogado.getEmpresa() != null) {
								...
								System.out.println("Saldo Empresa não disponível.");
							}
						...
						case 2: {
							System.out.println();
							System.out.println("************************************************************");
							System.out.println("PRODUTOS DE TODAS AS EMPRESAS");
